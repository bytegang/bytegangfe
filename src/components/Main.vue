    ...
    <el-container style="height: 100vh">
      <el-header>
        ...
        <div class="header-addons">
          ...
          <el-tooltip content="在线图片编辑器" placement="top">

            <el-link :underline="false" class="addon-icon" icon="el-icon-orange"
                     target="_blank"
                     href="/#/util/image-editor">
            </el-link>
          ...
          <el-dropdown @command="doCommand">
            ...
            <el-dropdown-menu slot="dropdown">
              ...
              <el-dropdown-item command="reset-password" icon="el-icon-guide">重置KSSOP-密码
              </el-dropdown-item>
              <el-dropdown-item command="reset-mfa" icon="el-icon-odometer">重置KSSOp-MFA</el-dropdown-item>
